...
We compare CascadeCBF (with minimal increment) against Spectral Bloom Filters (SBF-MI)~\cite{cohen2003spectral} and Count-Min Sketch (CMS)~\cite{cormode2005improved} on Zipfian data (10K unique items, 100K insertions).
