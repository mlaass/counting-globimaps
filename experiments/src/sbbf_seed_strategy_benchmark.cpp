 ...
 * - GDELT 2D: 1.9M real-world geographic events
 *
...
// Memory = num_blocks * bits_per_block / 8 bytes
// bits_per_element = (num_blocks * bits_per_block) / n
// num_blocks = n * bits_per_element / bits_per_block
